...
// Modified by github.com/0x0710 for TurtleCoin
...
namespace bytecoin {
    namespace parameters {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 3914525;  // addresses start with "TRTL"
        ...
        const uint64_t MINIMUM_FEE                          = UINT64_C(10);  // 0.1 TRTL
        const uint64_t DEFAULT_DUST_THRESHOLD               = UINT64_C(10);  // 0.1 TRTL
    ...
    const int WALLET_RPC_DEFAULT_PORT = 11899;
    ...
    constexpr const CheckpointData CHECKPOINTS[] = {};  // CryptoNote
}
